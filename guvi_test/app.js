$(document).ready(function(){
    ...
    $("#signup").click(function(){
        ...
        if(name.length != "" && email.length != "" && password.length != "" && age.length != "" && contactnumber.length != "" && dob.length != ""){
            $.ajax({
              type: "POST",
              url : "signup.php",
              data : {"name": name, "email": email, 'password': password, 'age': age, 'contactnumber': contactnumber, 'dob': dob},
              dataType: 'JSON',
